...
public abstract class Game implements Listener {
    ...
    private int creditsKill = 0;
    private int creditsWin = 0;
    ...
    public void setCreditsKill(int i) {
        creditsKill = i;
    }
    ...
    public void setCreditsLoss(int creditsLoss) {
        this.creditsLoss = creditsLoss;
    }
    ...
    private BlockFace getSleepingFace(Location loc) {
        ...
        while (block.getY() > 0 && block.getRelative(BlockFace.DOWN).getType().isTransparent()) {
