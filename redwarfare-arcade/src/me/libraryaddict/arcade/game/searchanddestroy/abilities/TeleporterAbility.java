...
public class TeleporterAbility extends Ability {
    ...
    public void onInteractBlock(PlayerInteractEvent event) {
        ...
        if (tele != null) {
            ...
            for (Barricade barricade : BarricaderAbility.allBarricades) {
                if (barricade.getBlock() == event.getClickedBlock()) {
    ...
    public void onInteractRemote(PlayerInteractEvent event) {
        ...
        if (!UtilInv.isItem(event.getItem(), Material.MAP) && !UtilInv.isItem(event.getItem(), Material.MAP))
            return;
    ...
    public void onTeleUnstable(TimeEvent event) {
        ...
        for (Teleporter tele : _teleporters) {
            ...
            b.getWorld().playEffect(b.getLocation(), Effect.STEP_SOUND, Material.ACACIA_LOG);
        }
    }
