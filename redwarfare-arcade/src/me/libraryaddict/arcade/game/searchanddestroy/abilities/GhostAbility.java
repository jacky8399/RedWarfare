            ...
            public void onPacketSending(PacketEvent event) {
                try {
                    ...
                    if (event.getPacketType() == PacketType.Play.Server.NAMED_SOUND_EFFECT) {
                        ...
                        String sound = RegistryMaterials.SOUND_EVENT.getKey(effect).getNamespace();
    ...
    public void onArrowHit(CustomDamageEvent event) {
        event.addRunnable(new DamageRunnable(getKit().getName() + " Hit") {
            ...
            public void run(CustomDamageEvent event2) {
                ...
                if (event.getAttackType() != AttackType.POISON && event.getAttackType() != AttackType.WITHER_POISON && event.getAttackType() != BarricaderAbility.getAttackType()) {
