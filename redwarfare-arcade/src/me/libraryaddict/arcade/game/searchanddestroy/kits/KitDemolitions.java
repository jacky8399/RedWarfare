...
public class KitDemolitions extends SnDKit
{
    ...
    public KitDemolitions()
    {
        ...
        setItems(
                ...
                new ItemBuilder(Material.STONE_PRESSURE_PLATE, 2).setTitle(C.Yellow + "Landmine").build());
    }
    ...
    public Material[] getArmorMats()
    {
        return new Material[]
            {
                    Material.GOLDEN_BOOTS, Material.CHAINMAIL_LEGGINGS, Material.CHAINMAIL_CHESTPLATE, Material.CHAINMAIL_HELMET
            };
    }
