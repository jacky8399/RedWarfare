...
public class IronGolemKillstreak extends StreakBase
{
    ...
    {
        ItemBuilder builder = new ItemBuilder(Material.GHAST_SPAWN_EGG);
        ...
        NBTTagCompound enitityTag = compound.getCompound("EntityTag");
        enitityTag.setString("id", "minecraft:iron_golem");
        compound.set("EntityTag", enitityTag);
    ...
    public void onLanded(Player player, Block block)
    {
        ...
        ironGolem.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(40);
        //ironGolem.getAttribute(Attribute.GENERIC_MAX_HEALTH).setBaseValue(40);
        ...
        try
        {
            ...
            goal.a(6, new PathfinderGoalMoveThroughVillage(golem, 1.0D, false, 1, () -> true));
