...
{
    private ItemStack _offhand = new ItemBuilder(Material.LIGHT_BLUE_STAINED_GLASS_PANE).setTitle(C.Aqua + "Offhand slot")
            .build();
    ...
    private void buildPage()
    {
        ...
        for (EquipmentSlot slot : EquipmentSlot.values())
        {
            ...
            if (item == null || item.getType() == Material.AIR)
            {
                item = new ItemBuilder(Material.BLUE_STAINED_GLASS_PANE).setTitle(
