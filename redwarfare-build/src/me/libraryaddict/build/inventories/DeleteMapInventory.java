...
public class DeleteMapInventory extends BasicInventory {
    ...
    public void buildCooldown(int i) {
        ...
        addItem(layout.next(),
                new ItemBuilder(Material.RED_WOOL).setTitle(C.Red + "Are you sure? (" + i + ")").build());
        addItem(layout.next(),
                new ItemBuilder(Material.RED_WOOL).setTitle(C.Red + "Are you sure? (" + i + ")").build());
    }
    ...
    public void buildPage() {
        ...
        addButton(layout.next(), new ItemBuilder(Material.RED_WOOL).setTitle(C.DGreen + "Delete").build(),
                new IButton() {
                    @Override
                    public boolean onClick(ClickType clickType) {
