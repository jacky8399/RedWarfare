...
public class MainBuildInventory extends BasicInventory {
    ...
    private void buildPage() {
        ...
        addButton(layout.next(), new ItemBuilder(Material.MAP).setTitle(C.Gold + "Select Map")
        ...
        addButton(layout.next(), new ItemBuilder(Material.POPPY).setTitle(C.DAqua + "Loaded maps")
        ...
        if (mapInfo != null && worldInfo.isEditor(getPlayer())) {
            addButton(layout.next(), new ItemBuilder(Material.WOODEN_AXE).setTitle(C.DGreen + "Build Tools").build(),
                    new IButton() {
                        @Override
                        public boolean onClick(ClickType clickType) {
                            WorldInfo worldInfo = _worldManager.getWorld(getPlayer().getWorld());
        ...
        if (worldInfo != null && worldInfo.isAdmin(getPlayer())) {
            if (info.isAdmin(getPlayer())) {
                addButton(layout.next(), new ItemBuilder(Material.WOODEN_SHOVEL).setTitle(C.Gold + "Builders").build(),
                        new IButton() {
                            @Override
                            public boolean onClick(ClickType clickType) {
            ...
            addButton(layout.next(),
                    new ItemBuilder(mapInfo.isAllowVisitors() ? Material.PLAYER_HEAD : Material.SKELETON_SKULL).setTitle(
            ...
            if (worldInfo.isAdmin(getPlayer())) {
                addItem(layout.next(), new ItemBuilder(Material.COMMAND_BLOCK)
