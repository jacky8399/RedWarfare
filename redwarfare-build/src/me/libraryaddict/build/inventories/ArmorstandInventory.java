...
public class ArmorstandInventory extends BasicInventory {
    ...
    private void registerButtons() {
        ...
        items.add(Pair.of(new ItemBuilder(getItem(getStand().getHelmet(), Material.SKELETON_SKULL))
        ...
        items.add(Pair.of(new ItemBuilder(Material.COMMAND_BLOCK).setTitle("Invulnerable: " + getStand().isInvulnerable())
                .build(), new IButton() {
            @Override
            public boolean onClick(ClickType clickType) {
        ...
        items.add(Pair.of(new ItemBuilder(Material.SMOOTH_STONE_SLAB).setTitle("Base Plate: " + getStand().hasBasePlate()).build(),
                new IButton() {
                    @Override
                    public boolean onClick(ClickType clickType) {
        ...
        items.add(Pair.of(new ItemBuilder(Material.WHEAT_SEEDS).setTitle("Small: " + getStand().isSmall()).build(),
                new IButton() {
                    @Override
                    public boolean onClick(ClickType clickType) {
