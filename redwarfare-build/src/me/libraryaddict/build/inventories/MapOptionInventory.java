...
public class MapOptionInventory extends BasicInventory {
    ...
    public void buildPage() {
        ...
        addButton(layout.next(), new ItemBuilder(Material.PLAYER_HEAD).setTitle(
        ...
        addButton(layout.next(), new ItemBuilder(Material.MAP).setTitle(C.Purple + "Export map").build(),
                new IButton() {
                    @Override
                    public boolean onClick(ClickType clickType) {
        ...
        addButton(layout.next(), new ItemBuilder(Material.COMMAND_BLOCK).setTitle(C.Purple + "Restore backup").build(),
                new IButton() {
                    @Override
                    public boolean onClick(ClickType clickType) {
