...
public class VoteRewardInventory extends BasicInventory
{
    ...
    private void buildPage(MysqlCheckCanVote checkCanVote)
    {
        ...
        ItemStack vip1Week = new ItemBuilder(Material.PURPLE_DYE).setTitle(C.DPurple + "VIP 1 Week")
        ...
        ItemStack vip1Month = new ItemBuilder(Material.PURPLE_DYE, 4).setTitle(C.DPurple + "VIP 1 Month")
        ...
        ItemStack vip3Months = new ItemBuilder(Material.PURPLE_DYE, 12).setTitle(C.DPurple + "VIP 3 Months")
        ...
        ItemStack vip6Months = new ItemBuilder(Material.PURPLE_DYE,24).setTitle(C.DPurple + "VIP 6 Months")
        ...
        addItem(layout.next(),
                new ItemBuilder(Material.PLAYER_HEAD).setTitle(C.Blue + "Refer a player for more tokens!")
