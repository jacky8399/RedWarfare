...
{
    private ArrayList<Portal> _portals = new ArrayList<>();
    private HashMap<ServerType, ArrayList<Server>> _runningServers;
    ...
    public PortalManager(JavaPlugin plugin, ServerManager serverManager)
    {
        ...
        _runningServers = new HashMap<ServerType, ArrayList<Server>>();
