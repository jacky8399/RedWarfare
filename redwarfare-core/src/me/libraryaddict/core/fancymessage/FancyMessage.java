 ...
 * methods will affect the current editing component, and a call to {@link #then()} or {@link #then()} will append a new
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable
{
        ...
        for (JsonElement mPrt : extra)
        {
            ...
            for (Map.Entry<String, JsonElement> entry : messagePart.entrySet())
            {
                ...
                if (TextualComponent.isTextKey(entry.getKey()))
                {
                    ...
                    Map<String, Object> serializedMapForm = new HashMap<String, Object>(); // Must be object due to Bukkit
                    ...
                    else
                    {
                        ...
                        for (Map.Entry<String, JsonElement> compositeNestedElement : entry.getValue().getAsJsonObject()
                                .entrySet())
                        {
    ...
    /**
     * Set the behavior of the current editing component to display information about an achievement when the client hovers over
     * the text.
     * <p>
     ...
     * 
     * @param name
     *            The name of the achievement to display, excluding the "achievement." prefix.
     * @return This builder instance.
     */
     ...
     *                If the specified {@code ChatColor} enumeration value is not a color (but a format value).
     */
    ...
    private Object createChatPacket(String json) throws IllegalArgumentException, IllegalAccessException, InstantiationException,
            InvocationTargetException, NoSuchMethodException, ClassNotFoundException
    {
        if (nmsChatSerializerGsonInstance == null)
        {
            // Find the field and its value, completely bypassing obfuscation
            Class<?> chatSerializerClazz = Reflection.getNMSClass("IChatBaseComponent$ChatSerializer");
        ...
        // Since the method is so simple, and all the obfuscated methods have the same name, it's easier to reimplement
        // 'IChatBaseComponent a(String)' than to reflectively call it
     ...
     * 
     * @param lines
     *            The lines of text which will be displayed to the client upon hovering. The iteration order of this object will
     ...
     * 
     * @param text
     *            The formatted text which will be displayed to the client upon hovering.
     * @return This builder instance.
     */
     ...
     * 
     * @param lines
     *            The lines of formatted text which will be displayed to the client upon hovering.
     * @return This builder instance.
     */
    public FancyMessage formattedTooltip(FancyMessage... lines)
    {
        ...
        result.messageParts.clear(); // Remove the one existing text component that exists by default, which destabilizes the
                                     // object
    ...
    public FancyMessage itemTooltip(final ItemStack itemStack)
    {
        try
        {
            ...
            return itemTooltip(
                    Reflection.getMethod(Reflection.getNMSClass("ItemStack"), "save", Reflection.getNMSClass("NBTTagCompound"))
     ...
     * 
     * @param itemJSON
     *            A string representing the JSON-serialized NBT data tag of an {@link ItemStack}.
     * @return This builder instance.
     */
    ...
    private void send(CommandSender sender, String jsonString)
    {
        ...
        try
        {
            ...
            Reflection.getMethod(connection.getClass(), "sendPacket", Reflection.getNMSClass("Packet")).invoke(connection,
                    createChatPacket(jsonString));
        }
        catch (IllegalArgumentException e)
        {
            Bukkit.getLogger().log(Level.WARNING, "Argument could not be passed.", e);
    ...
    public FancyMessage statisticTooltip(final Statistic which)
    {
        ...
        try
        {
            Object statistic = Reflection.getMethod(Reflection.getOBCClass("CraftStatistic"), "getNMSStatistic", Statistic.class)
                    .invoke(null, which);
     ...
     * @return This builder instance.
     * @exception IllegalArgumentException
     *                If the statistic requires a parameter which was not supplied, or was supplied a parameter that was not
     *                required.
     */
    public FancyMessage statisticTooltip(final Statistic which, EntityType entity)
    {
        ...
        try
        {
            Object statistic = Reflection
                    .getMethod(Reflection.getOBCClass("CraftStatistic"), "getEntityStatistic", Statistic.class, EntityType.class)
    ...
    public FancyMessage statisticTooltip(final Statistic which, Material item)
    {
        ...
        {
            Object statistic = Reflection
                    .getMethod(Reflection.getOBCClass("CraftStatistic"), "getMaterialStatistic", Statistic.class, Material.class)
     ...
     * @return This builder instance.
     * @exception IllegalArgumentException
     *                If any of the enumeration values in the array do not represent formatters.
     */
     ...
     * 
     * @param text
     *            The text, which supports newlines, which will be displayed to the client upon hovering.
     * @return This builder instance.
     */
     ...
     * 
     * @param lines
     *            The lines of text which will be displayed to the client upon hovering.
     * @return This builder instance.
     */
     ...
     * 
     * @param replacements
     *            The replacements, in order, that will be used in the language-specific message.
     * @return This builder instance.
     */
