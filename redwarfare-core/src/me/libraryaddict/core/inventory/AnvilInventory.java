...
public abstract class AnvilInventory extends BasicInventory {
    ...
    private class FakeAnvil extends ContainerAnvil {
        public FakeAnvil(EntityHuman entityhuman) {
            super(((CraftPlayer) getPlayer()).getHandle().nextContainerCounter(), entityhuman.inventory, ContainerAccess.a);
        ...
        public void a(String origString) {
            ...
            net.minecraft.server.v1_15_R1.ItemStack itemstack = getSlot(2).getItem();

            if (C.stripColor(_string).isEmpty()) {
                itemstack.s();
            } else {
                itemstack.a("display").setString("Name", _string);;
            }
