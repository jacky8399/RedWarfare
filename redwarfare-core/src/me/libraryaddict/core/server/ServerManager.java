    ...
    public ServerManager(JavaPlugin plugin, CommandManager commandManager)
    {
        ...
        try
        {
            for (String fileName : new String[]
                {
                        "Arcade.jar", "Build.jar", "Hub.jar", "GearWars.jar"
                })
            {
        ...
        else if (plugin.getName().contains("GearWars"))
        {
            _serverName = "GearWars";
            _gameType = ServerType.GearWars;
        }
        ...
        if (!isTestServer())
        {
            new BukkitRunnable()
            {
                public void run()
                {
                    new RedisListenerUpdate(_spinner, () -> new BukkitRunnable()
                    {
                        public void run()
                        {
                            checkUpdate();
