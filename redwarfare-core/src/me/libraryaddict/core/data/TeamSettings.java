...
public enum TeamSettings
{
    ...
    GREEN("Green Team", "Green", C.DGreen, C.DGreen, new ItemStack(Material.OAK_LEAVES), Color.GREEN, DyeColor.GREEN,
            ParticleColor.GREEN),

    PLAYER("Players", "Players", "", "", new ItemStack(Material.PLAYER_HEAD), Color.WHITE, DyeColor.WHITE,
            ParticleColor.WHITE),
