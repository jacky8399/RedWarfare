...
import me.libraryaddict.mysql.MysqlCreateTables;
...
public class MysqlManager {
    ...
    public MysqlManager(int idle) {
        ...
        try {
            ...
            _mysqlPool.setJdbcUrl("jdbc:mysql://${sqlhost}:${sqlport}/${sqldb}");
            _mysqlPool.setUser("${sqluser}");
            _mysqlPool.setPassword("${sqlpass}");
